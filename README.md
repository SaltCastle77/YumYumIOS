...
- 현재 알파버전(로컬)까지 진행 완료
  - 차후 디벨롭하여 배포까지 진행할 예정.
- Xcode : YUMYUM 실행 후 빌드 표시를 눌러서 진행합니다. 
...
1. 피드 작성 페이지
   ...
   - AI를 활용하여 음식 분석 후 음식명을 리뷰란에서 사용할 수 있도록 출력한다.

   

2. 메인페이지

   - 메인페이지의 배경으로 영상을 자동 반복 재생
   - 다른 유저가 작성한 피드를 접할 수 있는 페이지
   - 닉네임 클릭시 다른 유저의 마이페이지 접근 가능
   - 좋아요 항목을 지도에서 확인 가능
   - 카카오톡 공유 기능으로 해당 피드를 공유할 수 있음.

###  3) 검색 

1. 피드 검색

   - 음식명으로 피드를 검색할 수 있게 구성되어 있습니다. 

   - 해당 피드를 클릭하면 모달이 오픈되어 상세페이지로 갈 수 있습니다.
   - 콜렉션 뷰로 구성되어있으며, 유저, 유저프로필과 제목 그리고 요약된 리뷰를 확인할 수 있습니다.


2. 장소 검색 
   - 음식점명으로 검색할 수 있게 구성되어 있습니다. 
   - 장소를 클릭하면 해당 음식점에 작성된 리뷰들을 모아서 볼 수 있습니다.
   - 콜렉션 뷰로 구성되어 있으며, 클릭시 모달이 오픈되어 상세 피이지로 갈 수 있습니다.
...
1. 주변의 유저와 소통하고 싶을떄 사용할 수 있는 채팅기능이 포함되어 있습니다.
...
> 리뷰 내용과 좋아요, 카카오톡 공유 기능이 포함되어 있으며 `@닉네임` 을 클릭하면 해당 유저의 마이페이지로 이동할 수 있음.

![image-20210620180245011](README.assets/image-20210620180245011.png)



### 리뷰 작성 페이지

> 영상을 분석해 예상 음식을 음식명에 적을 수 있도록 표시해주고 리뷰와 위치를 선택할 수 있습니다.

![image-20210620183528960](README.assets/image-20210620183528960.png)

### 마이페이지

> 내가쓴 글과 좋아요한 피드를 볼 수 있으며 피드 수정과 삭제 기능이 구현되어 있습니다. 또한 지도를 클릭하면 음식점의 위치를 알 수 있습니다.

![image-20210620184338078](README.assets/image-20210620184338078.png)



### 설정페이지

> 설정 페이지에서는 회원정보를 수정과 로그아웃 그리고 개인정보 보호 정책을 확인할 수 있습니다.

![image-20210620184927063](README.assets/image-20210620184927063.png)

#### 채팅페이지 

> 사용자 위치를 기반으로 주변 4km이내의 유저들과 대화를 할 수 있습니다. 

<img src="README.assets/image-20210620185352130.png" alt="image-20210620185352130" width=30% />
